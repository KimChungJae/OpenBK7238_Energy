#!/usr/bin/env python3
# BK7238 HLW8112 ??IONE patch v7 (UFREQ: ?∞ÏÜç 0xFF ?§ÌÇµ)
...
old_off = """\t/* IONE_BK7238_REGFIX6: 3-wire read ???†Ìñâ 0xFF ?îÎ? ??8/16/32-bit??rx[1]Î∂Ä??*/
  	int off = (size == 3) ? 0 : 1;"""
