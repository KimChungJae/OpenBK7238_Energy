...
if "IONE_BK7238_REGFIX7" in text or "IONE_BK7238_REGFIX8" in text or "IONE_BK7238_REGFIX9" in text or "IONE_BK7238_REGFIX10" in text or "IONE_BK7238_REGFIX11" in text or "IONE_BK7238_REGFIX14" in text:
    print("Patch v7/v8/v9/v10 already applied")
    sys.exit(0)
