#!/usr/bin/env python3
# BK7238 HLW8112 ??IONE patch v8 (spifix6 ?ÑÏïï Î≥µÏõê + UFREQÎß??∞ÏÜç 0xFF ?§ÌÇµ)
...
if ("IONE_BK7238_REGFIX8" in text or "IONE_BK7238_REGFIX9" in text or "IONE_BK7238_REGFIX10" in text
        or "IONE_BK7238_REGFIX11" in text or "IONE_BK7238_REGFIX12" in text or "IONE_BK7238_REGFIX13" in text
...
/* IONE_BK7238_REGFIX7: 3-wire UFREQ ?????†Ìñâ 0xFF ?∞ÏÜç ?§ÌÇµ (24-bit ?ÑÏïï?Ä rx[0] ?†Ï?) */
...
/* IONE_BK7238_REGFIX8: 24-bit/?ºÎ∞ò 16-bit??spifix6(off=0/1), UFREQÎß?0xFF ?∞ÏÜç ?§ÌÇµ */
