#!/usr/bin/env python3
# BK7238 HLW8112 ??IONE patch v13 (UFREQ: 45~70Hz Hz ?§ÏΩî?¥ÎßÅ + ufreq ?îÎ≤ÑÍ∑?CMD)
...
\tint bestOff = 1;
\tint bestLe = 0;
\t/* 60Hz UFREQ reg ??7466 ??BE/LE Î™®Îëê ?§Ï∫î (LE 0x2A1D??BEÎ°?10781>9500 ?àÎùΩ) */
...
\t/* off√óBE/LE ?§Ï∫î + ?†Ìñâ 0xFF ?§ÌÇµ ??45~70Hz(Ch1 4500~7000)??Í∞Ä??Í∞ÄÍπåÏö¥ ?ÑÎ≥¥ */
\tfor (int off = 0; off <= 3; off++) {
\t\tfor (int le = 0; le <= 1; le++)
