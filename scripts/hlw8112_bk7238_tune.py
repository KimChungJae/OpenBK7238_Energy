...
if "IONE_BK7238_REGFIX19" in text:
    print("Patch v19 already in tree")
    sys.exit(0)
if "IONE_BK7238_REGFIX18" in text:
    print("Patch v18 already in tree")
    sys.exit(0)
if "IONE_BK7238_REGFIX17" in text:
    print("Patch v17 already in tree")
    sys.exit(0)
